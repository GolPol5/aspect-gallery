...
const PaymentPage = () => {
  ...
  return (
    <main data-screen-label="06 Оплата и доставка">
      ...
      <article className="article">
        ...
        <section id="rus">
          ...
          <table>
            <thead>
              <tr><th>Регион</th><th>Срок</th><th>Стоимость</th></tr>
            </thead>
            <tbody>
        ...
        <section id="world">
          ...
          <p>Доставка осуществляется логистическими операторами, специализирующимися на art-логистике: Crown Fine Art, Hasenkamp, Möbel Transport, Atelier 4. Стоимость доставки рассчитывается индивидуально и зависит от региона, размера и страховой стоимости работы.</p>
        </section>

        <section id="pack">
          <h2><span className="num">── 04</span>Упаковка и страховка</h2>
          <p>Каждая работа упаковывается в музейном стандарте: бескислотная бумага, защитный картон, угловые протекторы, термоусадочная плёнка, деревянный ящик при необходимости. Скульптура отправляется в индивидуальных контейнерах с пенополиуретановыми ложементами.</p>
        ...
        <section id="return">
          ...
          <p>Согласно законодательству РФ, произведения искусства не подлежат возврату или обмену как товар надлежащего качества. Однако галерея готова рассмотреть возврат или обмен в индивидуальном порядке — в течение 14 дней с момента получения работы при сохранении упаковки и отсутствии повреждений.</p>
          <p>В случае выявленных при получении дефектов или повреждений, возникших при транспортировке, страховая компания компенсирует ущерб в полном объёме. Свяжитесь с галереей в течение 48 часов и приложите фото повреждений.</p>
        </section>
...
const ContactsPage = () => {
  ...
  const submit = (e) => {
    ...
    setSent(true);
    setTimeout(() => { setSent(false); setName(''); setEmail(''); setSubject(''); setMsg(''); }, 2400);
  };

  return (
    <main data-screen-label="07 Контакты">
      <div className="page-hero">
      ...
      <div className="contacts-page">
        <div className="contacts-col">
          ...
          <div style={{marginTop: 56, display:'flex', gap: 8}}>
            ...
            <a href="#" className="btn-pill" style={{textDecoration:'none'}}><Icon name="instagram" size={14}/> Instagram</a>
        ...
        <div className="contacts-col">
          ...
          <form onSubmit={submit}>
            ...
            <button type="submit" className="btn filled large">Отправить <Icon name="arrow" size={14}/></button>
